...
export async function sendTelegramMsg (token)  {
    ...
    const payload = {
        ...
        photo: (token.image) ?  (token.image) : (token.platform == "pumpFun") ? "https://pbs.twimg.com/profile_images/1748108741503803392/EmT4yP6S_400x400.jpg" : "https://pbs.twimg.com/media/GREXuMhXEAAdQfA.jpg",
